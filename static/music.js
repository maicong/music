    ...
    applyBrowserStyles: function(object, applyToValue) {
        ...
        for (var key in object) {
            ...
            ret['-webkit-' + key] = applyToValue
                ? '-webkit-' + object[key]
                : object[key];
            ret['-moz-' + key] = applyToValue
                ? '-moz-' + object[key]
                : object[key];
            ret['-ms-' + key] = applyToValue
                ? '-ms-' + object[key]
                : object[key];
...
(function($) {
    $.fn.amazingaudioplayer = function(options) {
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            if (this.options.showtitle || this.options.showinfo) {
                ...
                if (this.options.showinfo) {
                    this.$info = $(
                        "<div class='amazingaudioplayer-info'></div>"
                    );
            ...
            var $playpause = $(
                "<div class='amazingaudioplayer-playpause'></div>"
            );
            var $play = $(
            ...
            if (
                ...
                this.$volume = $(
                    "<div class='amazingaudioplayer-volume'></div>"
                );
                ...
                if (this.options.showvolumebar) {
                    ...
                    this.$volumeBarAdjust
                        .bind(eStart, function(e) {
                            ...
                            var vol = parseFloat(
                                1 -
                                    (e0.pageY -
                                        instance.$volumeBarAdjust.offset()
                                            .top) /
                            ...
                            instance.$volumeBarAdjust.bind(eMove, function(e) {
                                ...
                                instance.amazingPlayer.audioPlayer.setVolume(
                                    vol
                                );
                            });
                        })
                    ...
                    this.$volume.hover(
                        ...
                        function() {
                            clearTimeout(instance.hideVolumeBarTimeout);
                            instance.hideVolumeBarTimeout = setTimeout(
                                function() {
                                    if (AmazingAudioPlatforms.isIE678()) {
            ...
            if (this.options.showtime) {
                ...
                this.container.bind('amazingaudioplayer.playprogress', function(
                    ...
                    var duration = isNaN(data.duration) ||
                        ...
                        ? 0
                        : data.duration;
                    var left = formatSeconds(
                        Math.ceil(duration - current / 1e3)
                    );
                    current = formatSeconds(Math.ceil(current / 1e3));
                    duration = formatSeconds(Math.ceil(duration / 1e3));
                    var t;
                    if (data.live) {
                        t = instance.options.timeformatlive.replace(
                            '%CURRENT%',
                            current
                        );
                    } else {
            ...
            if (this.options.showprogress) {
                ...
                this.container.bind('amazingaudioplayer.playprogress', function(
                    ...
                    if (
                        ...
                        progress = Math.ceil(
                            data.current * 100 / data.duration
                        );
                    }
                    $progressPlayed.css({
                        width: progress + '%'
            ...
            if (this.options.showtracklist) {
                ...
                this.container.bind('amazingaudioplayer.switched', function(
                    ...
                    if (data.current >= 0) {
                        ...
                        if (
                            instance.options.tracklistitem <
                            instance.amazingPlayer.elemLength
                        ) {
                            var page = Math.floor(
                                data.current / instance.options.tracklistitem
                            );
                            if (instance.tracklistPage !== page) {
                                instance.tracklistPage = page;
                                var t =
                                    -instance.tracklistPage *
                                    instance.tracklistItemHeight *
                                    instance.options.tracklistitem;
                ...
                for (var i = 0; i < this.amazingPlayer.elemLength; i++) {
                    var $track = $(
                        "<li class='amazingaudioplayer-track-item'></li>"
                    );
                    ...
                    $track.hover(
                        ...
                        function() {
                            if (
                                $(this).data('order') !==
                                instance.amazingPlayer.currentItem
                            ) {
                                $(this).removeClass(
                                    'amazingaudioplayer-track-item-active'
                                );
        ...
        var FlashHTML5Player = function(amazingPlayer, flashPlayerEngine) {
            ...
            this.supportMp3 = !!(a.canPlayType &&
                a.canPlayType('audio/mpeg;').replace(/no/, ''));
            this.supportOgg = !!(a.canPlayType &&
        ...
        FlashHTML5Player.prototype = {
            ...
            initHtml5: function() {
                var html5Object = $(
                    "<audio class='display-none' preload='" +
                        (this.amazingPlayer.options.preloadaudio
                            ? 'auto'
                            : 'none') +
                        "'></audio>"
                );
            ...
            play: function() {
                if (this.isHtml5) {
                    ...
                    this.flashObject.playAudio();
                else if (this.flashAudioLoaded)
                    this.playAudioAfterLoadedSucceed = true;
            ...
            getMp3Src: function() {
                ...
                for (var i = 0; i < audioSource.length; i++)
                    if (audioSource[i].type == 'audio/mpeg')
                        mp3Src = audioSource[i].src;
                return mp3Src;
            },
            pause: function() {
        ...
        AmazingAudioPlayer.prototype = {
            ...
            init: function(instance) {
                ...
                if (instance.options.defaultvolume >= 0) {
                    instance.setVolume(
                        parseFloat(
                            instance.options.defaultvolume / 100
                        ).toFixed(1)
                    );
                }
                instance.container.bind('amazingaudioplayer.stop', function(
                    event,
                    id
                ) {
            ...
            audioRun: function(index, autoPlay) {
                ...
                var nextItem;
                if (index === -2) {
                    nextItem = this.currentItem <= 0
                        ? this.elemLength - 1
                        : this.currentItem - 1;
                } else if (index === -1) {
                    nextItem = this.currentItem >= this.elemLength - 1
                        ? 0
                        : this.currentItem + 1;
                } else {
                    nextItem = index;
            ...
            playAudio: function() {
                ...
                this.container.trigger(
                    'amazingaudioplayer.played',
                    this.currentItem
                );
                if (this.options.stopotherplayers) {
                    if (
                        amazingAudioPlayerObjects &&
                        amazingAudioPlayerObjects.objects
                    ) {
                        for (
                            var i = 0;
                            i < amazingAudioPlayerObjects.objects.length;
                            i++
                        ) {
                            if (
                                amazingAudioPlayerObjects.objects[i].id ===
                                this.id
                            ) {
                                continue;
                            }
            ...
            loadProgress: function(progress) {
                this.container.trigger(
                    'amazingaudioplayer.loadprogress',
                    progress
                );
            },
            playProgress: function(current, duration) {
                ...
                var d0 = this.elemArray[this.currentItem].duration * 1e3 >
                    duration ||
                    isNaN(duration) ||
                    !isFinite(duration)
        ...
        this.each(function() {
            ...
            var object = new AmazingAudioPlayer(
                $(this),
                this.options,
                audioplayerid
            );
...
if (typeof AmazingFlashAudioPlayerReady === 'undefined') {
    ...
    function amazingFlashAudioPlayerEventHandler(
        event,
        playerid,
        param,
        param1
        ...
        switch (event) {
            ...
            case 'loadprogress':
                ...
                break;
            case 'playprogress':
                amazingAudioPlayerObjects.objects[id].playProgress(
                    param,
                    param1
                );
                break;
                ...
                if (ua.pv[0] > 0) {
                    ...
                    if (obj)
                        if (
                            ...
                            for (var j = 0; j < pl; j++)
                                if (
                                    p[j].getAttribute('name').toLowerCase() !=
                                    'movie'
                                )
                                    par[p[j].getAttribute('name')] = p[
                                        j
                                    ].getAttribute('value');
